 ...
 * @author delll
 */
public class girispersonel extends javax.swing.JFrame {

    /**
     * Creates new form girissifre
     */
    public girispersonel() {
        initComponents();
    }
public void giris(String gkadi, String gsifre) throws SQLException {
        ...
        try {
            ...
            if (rs.first()) {
                ...
                if (rs.getString("kadi").equals("personel")) {
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    ...
                    .addGroup(jPanel4Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel4Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            .addComponent(sifre, javax.swing.GroupLayout.DEFAULT_SIZE, 120, Short.MAX_VALUE)
        ...
        getContentPane().add(jLabel6, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 790, 532));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(girispersonel.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new girispersonel().setVisible(true);
            }
        });
    }
